...
const SuperEditableSpan: React.FC<SuperEditableSpanType> = (
    ...
    const onEnterCallback = () => {
        ...
        setEditMode(editMode => !editMode);  // -- added by student

        onEnter?.()
    }
    const onBlurCallback = (e: React.FocusEvent<HTMLInputElement>) => {
        // выключить editMode при нажатии за пределами инпута // делают студенты - ok
    ...
    const onDoubleClickCallBack = (
        ...
        // включить editMode при двойном клике // делают студенты - ok
